...
\section{La séquence}
	...
	\begin{Emphase}{Instructions élémentaires}
		...
		\begin{pseudo}
		\Stmt{\K{Avancer}}
		\LineComment{Le robot se déplace d'une case dans la direction vers laquelle il regarde}
		\Stmt{\K{ADroite}}
		\LineComment{Le robot tourne d'un quart de tour vers la droite.}
		\LineComment{Ainsi, s'il regardait en bas, il regarde à présent à gauche.}
		\end{pseudo}
		}
	\end{Emphase}
...
\section{Les alternatives}
	...
	\begin{Emphase}{Les tests}
		...
		\begin{pseudo}
		\Stmt{\K{devantMur}}
		\LineComment{est vrai si le robot fait \textbf{face} à un mur.}
		\Stmt{\K{devantTrésor}} 
		\LineComment{est vrai si le robot fait face au trésor.}
		\Stmt{\K{devantMarque}}
		\LineComment{est vrai si le robot fait face à une marque.}
		\Stmt{\K{surMarque}}
		\LineComment{est vrai si le robot est sur une marque.}
		\Stmt{\K{non}, \K{et}, \K{ou}}
		\LineComment{De plus, le robot est capable d'effectuer des 
			\emph{calculs logiques}}
		\LineComment{grâce à ces opérateurs.}
		\end{pseudo}
		}
	\end{Emphase}
...
\section{Les marques du robot}
	...
	\begin{Emphase}{Instructions élémentaires}
		...
		\Stmt{\K{ajouterMarque}} 
			\LineComment{Le robot trace une croix sur la case qu'il occupe.}
		\Stmt{\K{effacerMarque}}
			\LineComment{Le robot efface la croix sur la case qu'il occupe.}
		\end{pseudo}
		}
	\end{Emphase}
	...
	\begin{Emphase}{Test}
		...
		\begin{pseudo}
		\Stmt{\K{surMarque}}
			\LineComment{Est vrai si le robot est dans une case marquée d'une croix.}
		\end{pseudo}
		}
	\end{Emphase}
