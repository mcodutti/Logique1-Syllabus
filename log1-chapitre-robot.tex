...
%\includegraphics[width=1.27cm,height=1.27cm]{log1-img/log1-img11}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=5.553cm,height=5.302cm]{log1-img/log1-img12}
...
(\textstyleInternetlink{https://gforge.inria.fr/frs/?group\_id=2929})}
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.296cm,height=1.296cm]{log1-img/log1-img13}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img14}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.282cm,height=1.282cm]{log1-img/log1-img15}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.282cm,height=1.282cm]{log1-img/log1-img16}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.244cm,height=1.296cm]{log1-img/log1-img17}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.323cm,height=1.323cm]{log1-img/log1-img18}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.323cm,height=1.323cm]{log1-img/log1-img19}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img20}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.323cm,height=1.323cm]{log1-img/log1-img21}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.282cm,height=1.282cm]{log1-img/log1-img22}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.282cm,height=1.282cm]{log1-img/log1-img23}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img24}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.282cm,height=1.282cm]{log1-img/log1-img25}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.323cm,height=1.323cm]{log1-img/log1-img26}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img27}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.282cm,height=1.282cm]{log1-img/log1-img28}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.244cm,height=1.296cm]{log1-img/log1-img29}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img30}
...
%\begin{center}
%\tablehead{}
%\begin{supertabular}{m{2.869cm}m{0.90599996cm}m{3.144cm}m{3.141cm}m{3.141cm}}
%~

%\centering  Algorithme A &
%~
 %&
%\centering  Algorithme 
%(procédure) Brol &
%~
 %&
%\centering\arraybslash  Ordre
%d'exécution des instructions\\\hhline{-~-~-}
%\multicolumn{1}{|m{2.869cm}|}{\raggedleft {
%Instruction A1}\par

%\raggedleft { Brol}\par

%\raggedleft { Instruction A2}\par

%\raggedleft  Brol} &
%\multicolumn{1}{m{0.90599996cm}|}{[Warning: Draw object ignored]} &
%\multicolumn{1}{m{3.144cm}|}{{ Instruction B1}

 %Instruction B2} &
%\multicolumn{1}{m{3.141cm}|}{~
%} &
%\multicolumn{1}{m{3.141cm}|}{\centering {
%Instruction A1}\par

%\centering { Instruction B1}\par

%\centering { Instruction B2}\par

%\centering { Instruction A2}\par

%\centering { Instruction B1}\par

%\centering\arraybslash  Instruction
%B2}\\\hhline{-~-~-}
%\end{supertabular}
%\end{center}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.282cm,height=1.282cm]{log1-img/log1-img31}
