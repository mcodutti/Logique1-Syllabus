...
\cadre{
\begin{pseudo}
	\Stmt \Read nomFichier ; nomVariable
\end{pseudo}
}
...
\cadre{
\begin{pseudo}
	\Stmt \Write nomFichier ; nomVariable
\end{pseudo}
}
...
\begin{pseudo}
	\Module{parcoursFichier}{}{}
		...
		\Stmt \Read nomFichier ; enregistrement
...
\begin{pseudo}
	\Module{copieFichier}{}{}
		...
		\While{NON EOF(fichierIn)}
			\Write fichierOut ; enregistrement
			\Read fichierIn ; enregistrement
		\EndWhile
