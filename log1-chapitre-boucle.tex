...
{\sffamily
\textstyleMotCl{tant que} condition \textstyleMotCl{faire}}

\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img84}

\end{center}
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=5.173cm,height=5.928cm]{log1-img/log1-img85}
...
\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img87}
...
{\sffamily
\textstyleMotCl{jusqu'à ce que} condition}
...
{\sffamily
\textstyleMotCl{pour} variable \textstyleMotCl{de} début
\textstyleMotCl{à} fin [\textstyleMotCl{par} pas]
\textstyleMotCl{faire}}

\begin{center}
 [Warning: Image ignored] % Unhandled or unsupported graphics:
%\includegraphics[width=1.129cm,height=1.282cm]{log1-img/log1-img88}
