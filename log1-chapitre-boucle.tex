...
% =================
	...
	\subsection{Exemple 1 -- Compter de 1 à 10}
		...
		\cadre{
		\begin{pseudo}
		\LComment Ce module affiche les nombres de 1 à 10.
	...
	\subsection{Exemple 2 -- Compter de 1 à beaucoup}
		...
		\cadre{
		\begin{pseudo}
		\LComment Ce module lit un nombre et affiche les nombres de 1 à ce nombre.
		\Module{afficherN}{}{} 
			\Decl nb, n : entier
			\Read n
			\For{nb \K{de} 1 \K{à} n} 
	...
	\subsection{Exemple 3 -- Afficher les nombres pairs}
		...
		\cadre{
		\begin{pseudo}
		\LComment Ce module lit un nombre et affiche les nombres pairs jusqu'à ce nombre.
		\Module{afficherPair}{}{} 
			\Decl nb, n : entier
			\Read n
	...
	\subsection{Exemple 4 -- Afficher les premiers nombres pairs}
		...
		\cadre{
		\begin{pseudo}
		\LComment Ce module lit un nombre et affiche ce nombre de nombres pairs.
		\Module{afficherPair}{}{} 
			\Decl i, n : entier
			\Read n
			\For{nb \K{de} 1 \K{à} n} 
	...
	\subsection{Exemple 5 -- Somme de nombres}
		...
		\cadre{
		\begin{pseudo}
		\LComment Ce module lit des valeurs entières et retourne la somme des valeurs lues.
