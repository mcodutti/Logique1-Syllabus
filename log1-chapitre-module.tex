...
\section{Introduction}
	...
	\cadre{
	\begin{pseudo}
	\LComment Ce module lit deux nombres et affiche le maximum des deux.
	\Module{max2}{}{}
		\Decl a,b,max~: réels
		\Read a,b
		\If{a > b}
	...
	\begin{pseudo}
	\Module{max3}{}{}
		\LComment Ce module lit trois nombres et affiche le maximum des trois.
...
\section{Passage de paramètres}
	...
	\cadre{
	\begin{pseudo}
	\LComment Ce module reçoit deux nombres et sort le maximum des deux.
...
\section{Variables locales}
	...
	\cadre{
	\begin{pseudo}
	\LComment Ce module lit trois nombres positifs et affiche le maximum des trois.
	\Module{max3}{}{}
		\Decl a,b,c,temp,max~: réels
		\Stmt lirePositif(a)
		\Stmt lirePositif(b)
	...
	\cadre{
	\begin{pseudo}
	\LComment Ce module lit un nombre, le sort s'il est positif et sinon lance une erreur.
...
\section{Module renvoyant une valeur}
	...
	\cadre{
	\begin{pseudo}
	\LComment Ce module lit un nombre, le retourne s'il est positif et sinon lance une erreur.
	...
	\cadre{
	\begin{pseudo}
	\LComment Ce module reçoit deux nombres et retourne le maximum des deux.
...
\subsection*{Conversion en secondes}
	...
	\cadre{
	\begin{pseudo}
		\LComment Ce module reçoit trois entiers~: des heures, des minutes et des secondes et sort le nombre de secondes correspondant.
	...
	\cadre{
	\begin{pseudo}
		\LComment Ce module reçoit trois entiers~: des heures, des minutes et des secondes et retourne le nombre de secondes correspondant.
...
\subsection{Conversion en heures-minutes-secondes}
	...
	\cadre{
	\begin{pseudo}
		\LComment Ce module reçoit un nombre de secondes et sort les heures, les minutes et les secondes correspondant.
...
\subsection{La solution}
	...
	\cadre{
	\begin{pseudo}
		\LComment Ce module lit deux moments (h-m-s) et affiche le moment de la différence entre les deux.
...
\begin{Exercice}{Comparaison d'algorithmes}
	...
	\cadre{
	\begin{pseudo}
		\LComment Ce module reçoit un entier et retourne vrai si il est pair et faux sinon.
