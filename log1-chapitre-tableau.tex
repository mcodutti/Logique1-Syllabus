...
\begin{Exercice}{Somme}
	...
	\textstyleCodeInsr{tabEnt} de \textstyleCodeInsr{n} entiers 
...
\begin{Exercice}{OXO}
	...
	\multicolumn{1}{|m{0.35cm}|}{\centering 
	O} &
	\multicolumn{1}{m{0.35cm}|}{\centering  X}
	&
	\multicolumn{1}{m{0.35cm}|}{\centering  X}
	&
	\multicolumn{1}{m{0.35cm}|}{\centering  O}
	&
	\multicolumn{1}{m{0.35cm}|}{\centering  X}
	&
	\multicolumn{1}{m{0.35cm}|}{\centering  O}
	...
	\multicolumn{1}{m{0.35cm}|}{\centering  O}
	&
	\multicolumn{1}{m{0.35cm}|}{\centering\arraybslash
	 X}\\\hline
	\end{supertabular}
	\end{center}
\end{Exercice}
