...
\cadre{
\begin{pseudo}
\LComment Ce module lit un nombre et affiche si ce nombre est positif (zéro inclus)
ou strictement négatif
\Module{signeNombre}{}{}
	\Decl nb : entier
	\Read nb
...
\cadre{
\begin{pseudo}
\LComment Ce module lit un nombre entre 1 et 7 et affiche en clair le jour de la semaine correspondant.
\Module{jourSemaine}{}{}
\Decl jour : entier
\Read jour
	\Switch{jour \K{vaut}}
...
\cadre{
\begin{pseudo}
\LComment Ce module lit un Mois et affiche le nombre de jours correspondant
