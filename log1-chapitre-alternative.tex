...
\begin{Emphase}[exercice]{Exercice résolu : Signe d'un nombre}
...
\begin{Emphase}[exercice]{Exercice résolu : Nombre de jours (avec énumération)}
...
\begin{Emphase}[exercice]{Exercice : Signe d'un nombre (avec selon-que)}
