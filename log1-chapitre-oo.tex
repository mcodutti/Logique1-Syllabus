...
\begin{enumerate}
	\item 
		...
		\begin{liste}
			\item 
				calculer le bénéfice net en euros
			\item 
				calculer le prix de vente hors tva
			\item 
				calculer le prix de vente tvac
			\item 
				donner la quantité restant en stock
			\item 
				dire si oui ou non l'article est en rupture de stock.
		\end{liste}
...
\begin{enumerate}
	\item 
		...
		méthodes. Regroupez le tout en une classe \textstyleCodeInsr{Article}
...
\begin{enumerate}
	\item {
		Écrivez un ou des constructeur(s) pour un \textstyleCodeInsr{Article}}
	\item {
...
\begin{Exercice}{Un article}
	Reprenez la classe \textstyleCodeInsr{Article} qui a servi
