...
\begin{enumerate}
	...
	\item 
		Écrivez la méthode qui calcule le bénéfice réalisé lors de la vente d'un produit.
\end{enumerate}
\end{Emphase}
\bigskip
...
paramètre \textstyleCodeInsr{uneHeure} vaut 25 ? Une valeur aberrante serait
...
s'interrompe plutôt que de fournir une mauvaise réponse. 
...
des langages comme Java par exemple (cela vous sera expliqué
plus tard).
...
\begin{liste}
	...
	\item {
		...
		\textstyleCodeInsr{getTotalMinutes()} retourne 83. Idem avec 
